...
const Ragistration = ()=>{
    ...
    return(
        <div className="container-fluid ps-md-0"   style={{marginTop:"30px"}}>
            <div className="row g-0">
                {/* <div className="d-none d-md-flex col-md-4 col-lg-5 bg-image-reg"></div> */}
                <div className="col-md-8 col-lg-12">
                    <div className="login d-flex align-items-center py-0">
                        <div className="container">
                            <div className="row">
                                <div className="col-md-9 col-lg-8 mx-auto">
                                    <div className="text-center my-container-reg" id="id12">
