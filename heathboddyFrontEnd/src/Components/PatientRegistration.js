...
const PatientRegistration = function () {
    ...
    const submitHandler =function(data){
        ...
        ApiServics.patientRegistion(data)
        .then(resp=>{
    ...
    return (
        <form onSubmit={handleSubmit(submitHandler)} method="post" className="needs-validation" id = "id12" noValidate autoComplete="off">
            <p>Please fill in this form to create an acount!</p>
            <hr />
            <div className="form-group">
                <div className="row">
                    <div className="col-md-6">
                        <input type="number" className={classNames("form-control", { "is-invalid": errors.pid })} name="pid" placeholder="Enter User ID"
                            {
                            ...register("pid", {
                    ...
                    <div className="col-md-6">
                        <input type="text" className={classNames("form-control", { "is-invalid": errors.name })} name="name" placeholder="Enter Name"
                            {...register("name", {
            ...
            <div className="form-group">
                <div className="col-md-14">
                    <input type="email" className={classNames("form-control",{"is-invalid": errors.email})} name="email" placeholder="Enter Email"
                        {...register("email",{
