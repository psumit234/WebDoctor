...
const FindDoctor = () => {
    ...
    const searchHandler = () => {
        if (search && search.city && search.speciality) {
            ApiServics.findDoctor(search.city, search.speciality)
                .then(resp => {
            ...
            <div className='container d-flex flex-column align-items-center justify-content-center'>
                ...
                <div className='row mt-1'>
                    <div className="btn-group">
                        ...
                        <Link class="btn btn-primary" to="/appointment" style={{marginLeft:"4px"}} role="button">Book Appoitment</Link>
                        <Link class="btn btn-primary" to="/getAppDetails" style={{marginLeft:"4px"}}  role="button">Appoitment Details</Link>
                    </div>
                </div>
